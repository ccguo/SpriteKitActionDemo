...
//        //改变Sprite的texture
//        
//        NSString *fileName = [NSString stringWithFormat:@"%@", @"ship1.png"];
...
//    NSArray *path = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//    NSString *document = [path objectAtIndex:0];
    NSString *yan1 = [NSString stringWithFormat:@"%@", @"walkR01.png"];
    NSString *yan2 = [NSString stringWithFormat:@"%@", @"walkR02.png"];
    NSString *yan3 = [NSString stringWithFormat:@"%@", @"walkR03.png"];
    NSString *yan4 = [NSString stringWithFormat:@"%@", @"walkR04.png"];
    NSString *yan5 = [NSString stringWithFormat:@"%@", @"walkR05.png"];
    ...
    */
    ...
    SKAction *move = [SKAction moveByX:150 y:0 duration:1];
    ...
    SKAction *moveBack = [SKAction moveByX:-150 y:0 duration:1];
